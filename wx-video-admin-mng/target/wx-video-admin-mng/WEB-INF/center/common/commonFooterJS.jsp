...
<input type="hidden" id="apiServer" name="apiServer" value="https://www.jiekk.cn/v"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://118.25.83.140:8080/mvc"/>
